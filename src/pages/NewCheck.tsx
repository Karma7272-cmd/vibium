  ...
  return (
    <div className="min-h-screen flex w-full bg-background dark:sunrise-gradient">
      ...
      <SidebarInset className="flex-1 flex flex-col relative">
        ...
        <div 
          className={`flex-1 bg-cover bg-center bg-no-repeat px-4 ${isMobile ? "h-[calc(100vh-3rem)]" : "min-h-0"} dark:bg-none`}
          style={{
            backgroundImage: 'url(/lovable-uploads/cb74d150-219f-4482-9827-030133cb31ce.png)'
          }}
        >
