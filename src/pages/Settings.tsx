...
import { Palette, Database, Share2 } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-base sm:text-lg text-gray-600 dark:text-muted-foreground">
                Manage your application preferences and connectors
              </p>
            </div>

            <Tabs defaultValue="data-sources" className="space-y-6">
              <TabsList className="flex flex-col sm:inline-flex sm:flex-row w-full sm:w-auto h-auto sm:h-10 p-1 bg-background/80 dark:bg-card/40 backdrop-blur-sm">
